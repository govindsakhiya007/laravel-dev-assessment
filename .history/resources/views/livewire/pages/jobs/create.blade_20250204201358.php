<div>
    <div class="container mx-auto py-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <form wire:submit.prevent="saveJob" class="grid grid-cols-2 gap-4 bg-white p-4 rounded shadow-md"><h2 class="text-lg font-semibold mb-4 bg-gray-100 px-4 py-2">Job details</h2>
