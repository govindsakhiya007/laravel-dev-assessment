            ...
            <div class="col-span-2">
                ...
                <div class="bg-white rounded shadow-md p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea wire:model="description" class="w-full rounded-lg border-gray-300 focus:ring-blue-500" placeholder="Description"></textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium mb-1">Extra Info (Comma Separated)</label>
							...
							<p class="text-sm text-gray-500 mt-1">Please use comma seperated values.</p>
            ...
            <div class="">
                ...
                <div class="bg-white rounded shadow-md p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model="company_name" class="w-full rounded-lg border-gray-300 focus:ring-blue-500" placeholder="Enter company name">
                        @error('company_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-1">Logo</label>
                        <input type="file" wire:model="company_logo" class="w-full rounded-lg border-gray-300 focus:ring-blue-500">
