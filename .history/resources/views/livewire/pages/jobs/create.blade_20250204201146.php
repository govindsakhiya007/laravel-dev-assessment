<div>
    <div class="container mx-auto py-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <form wire:submit.prevent="saveJob" class="grid grid-cols-2 gap-4 bg-white p-4 rounded shadow-md"></form wire:submit
            <div class="bg-white rounded shadow-md p-4">
                ...
                <form wire:submit="save">
                    ...
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 w-full">Save</button>
                </form>
            </div>
