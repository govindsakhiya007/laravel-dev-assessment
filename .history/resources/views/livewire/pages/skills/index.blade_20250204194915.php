<div>
    <div class="container mx-auto py-4">
        ...
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"></d
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded shadow-md p-4">
                <h2 class="text-lg font-semibold mb-4 bg-gray-100 px-4 py-2">{{ $skillId ? 'Update skill' : 'Add new skill' }}</h2>
