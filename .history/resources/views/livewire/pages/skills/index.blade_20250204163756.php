    ...
    <div class="container mx-auto py-4">
        ...
        <!-- Skills Table -->
            ...
            <div class="bg-white rounded shadow-md p-4">
                <h2 class="text-lg font-semibold mb-4">{{ $skillId ? 'Update skill' : 'Add New' }}</h2>
                <form wire:submit="save">
                    <div class="mb-4">
                        <input type="text" wire:model="name" placeholder="Skill name" class="border rounded p-2 w-full mr-2 focus:outline-none">
