...
class Index extends Component
{
    ...
    public function save()
    {
        ...
        if ($this->editSkillId) {
            ...
            $this->dispatchBrowserEvent('alert', ['type' => 'success', 'message' => 'Skill updated successfully!']);
            session()->flash('message', 'Skill updated successfully!');
        } else {
            Skill::create(['name' => $this->name]);
            $this->dispatchBrowserEvent('alert', ['type' => 'success', 'message' => 'Skill created successfully!']);
